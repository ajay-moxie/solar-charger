...
OBJECTS= ADC.p1 Charging.p1 Intensity_Switch.p1 LED.p1 Load_Switch.p1 PWM.p1 SYSTEM.p1 TIMER.p1 temp.p1 interrupt.p1 main.p1 led_load.p1 battery_mgmt.p1 load_mgmt.p1 power_mgmt.p1 pv_mgmt.p1 battery_pi.p1 port.p1
DEPS= ADC.h Charging.h intensity_switch.h LED.h Load_Switch.h PWM.h SYSTEM.h TIMER.h temp.h interrupt.h led_load.h pi.h battery_mgmt.h common.h load_mgmt.h power_mgmt.h pv_mgmt.h battery_pi.h config.h port.h
...
lantern:
	cp configs/lantern.config config.h
clean:
